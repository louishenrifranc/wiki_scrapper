...
class Cache:
    def __init__(self, func):
        ...
        self._num_calls = 0
        self._save_every_iter = 5
        print(os.getpid(), "new object")
    ...
    def _serialize(self):
        ...
        file_path = os.path.join(dir_path, func.__name__ + "_cache_" + str(os.getpid()) + ".pkl")
    ...
    def __call__(self, lock, url: str):

        # if self._num_calls % self._save_every_iter == 0:
        #     self._serialize()
        print(os.getpid(), self.func.__name__, len(self._cache))
